<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebAppDELICIAS.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Label ID="lblinfo" runat="server" ForeColor="Yellow"></asp:Label>
            </div>
            <div class="col-md-offset-2 col-md-10">
