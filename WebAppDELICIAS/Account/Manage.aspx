<%@ Page Title="Administrar cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="WebAppDELICIAS.Account.Manage" %>
        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd><%: LoginsCount %>
                        <asp:HyperLink NavigateUrl="/Account/ManageLogins"  runat="server" />
                    ...
                    <dd>
                        <p>
                            Esta versión de su Aplicación Web no contiene ningún proveedor de doble autenticación configurado. <%--Consulte <a href="https://go.microsoft.com/fwlink/?LinkId=403804">este artículo</a>
